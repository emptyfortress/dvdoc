const errors = [
	...
	},
	{
		...
		fixed: [
			...
			{ id: 'ERR-0000', text: 'Ошибка контрола файла согласования.' },
	...
	},
	{
		...
		fixed: [
			...
			{ id: 'ERR-1218', text: 'После изменения файла не обновляется версия.' },
			{
				id: 'ERR-1216',
	...
	},
	{
		...
		fixed: [
			...
			{ id: 'ERR-0000', text: 'Не сохраняется значение нумератора.' },
			{
				id: 'ERR-1206',
			...
			{ id: 'ERR-0000', text: 'Правка для сценария автоматического объединения версий.' },
