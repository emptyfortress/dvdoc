const errors = [
	{
		...
		fixed: [{ label: 'ERR-2514', text: 'Ошибка при обновлении ВК' }],
	},
	{
		id: '1',
		...
		fixed: [
			...
			{ label: 'ERR-2222', text: 'Текст метки ЭУ переносится на новую строку справа от метки.' },
		],
	},
	{
		id: '2',
	...
	},
	{
		...
		fixed: [
			...
			{ label: 'ERR-1842', text: 'Не работает группировка в новом гриде для числовых колонок.' },
			{
				label: 'ERR-1880',
			...
			{ label: 'ERR-1566', text: 'Ошибка при генерации номера документа : Internal Server Error.' },
		],
	},
	{
		id: '4',
		...
		fixed: [
			...
			{ label: 'ERR-1669', text: 'Не добавляется ссылка на файл в контроле PartnersDepartment.' },
			{
				label: 'ERR-1360',
			...
			{ label: 'ERR-1529', text: 'Ошибка при попытке добавления файла через контрол FilePicker.' },
			{
				label: 'ERR-1260',
	...
	},
	{
		...
		fixed: [
			...
			{ label: 'WebC-11062', text: 'Блок с файлом отчета по умолчанию отображается свёрнутым.' },
			{
				label: 'ERR-1218',
	...
	},
	{
		...
		func: [
			...
			{ label: 'Избранные карточки', text: 'Добавлена возможность добавить карточку в избранное.' },
			{
		...
		fixed: [
			...
			{ label: 'ERR-1001', text: 'Некорректное отображение кодировки файла при предпросмотре.' },
			{
				label: 'ERR-947',
	...
	},
	{
		...
		fixed: [
			...
			{ label: 'ERR-901', text: 'Не применяется сортировка в поисковых папках в старом гриде.' },
			{ label: 'ERR-988', text: 'Проблемы с сохранением карточек задания в разметке просмотра.' },
			{
				label: 'ERR-921',
